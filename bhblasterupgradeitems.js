function bhblasterupgradeitems(){
	...
	let upw3speed = new Shopitem("blaster",3,"speed",1); //27
	let upw4speed = new Shopitem("blaster",4,"speed",1); //28
	let upw5speed = new Shopitem("blaster",5,"speed",1); //29
	let upw7speed = new Shopitem("blaster",7,"speed",1); //30
	let upw8speed = new Shopitem("blaster",8,"speed",1); //31
	let upw9speed = new Shopitem("blaster",9,"speed",1); //32
	//let upw10speed = new Shopitem("blaster",10,"speed",1); //speed  upgrades increase projectile speed
	let upw11speed = new Shopitem("blaster",11,"speed",1); //33
	let upw12speed = new Shopitem("blaster",12,"speed",1); //34
	let upw13speed = new Shopitem("blaster",13,"speed",1); //35
	let upw14speed = new Shopitem("blaster",14,"speed",1); //36
	let upw15speed = new Shopitem("blaster",15,"speed",1); //37
	let upw17speed = new Shopitem("blaster",17,"speed",1); //38
	let upw18speed = new Shopitem("blaster",18,"speed",1); //39
	let upw19speed = new Shopitem("blaster",19,"speed",1); //40
	...
	let upw0timer = new Shopitem("blaster",0,"timer",1); //41 timer upgrades increase projectile lifespan
	let upw1timer = new Shopitem("blaster",1,"timer",1); //42
	let upw2timer = new Shopitem("blaster",2,"timer",1); //43
	let upw3timer = new Shopitem("blaster",3,"timer",1); //44
	let upw4timer = new Shopitem("blaster",4,"timer",1); //45
	let upw5timer = new Shopitem("blaster",5,"timer",1); //46
	let upw6timer = new Shopitem("blaster",6,"timer",1); //47
	let upw7timer = new Shopitem("blaster",7,"timer",1); //48 
	let upw8timer = new Shopitem("blaster",8,"timer",1); //49
	let upw9timer = new Shopitem("blaster",9,"timer",1); //50
	//let upw10timer = new Shopitem("blaster",10,"timer",1); //timer upgrades increase projectile lifespan
	let upw11timer = new Shopitem("blaster",11,"timer",1); //51
	let upw12timer = new Shopitem("blaster",12,"timer",1); //52
	let upw13timer = new Shopitem("blaster",13,"timer",1); //53
	let upw14timer = new Shopitem("blaster",14,"timer",1); //54
	let upw15timer = new Shopitem("blaster",15,"timer",1); //55
	let upw16timer = new Shopitem("blaster",16,"timer",1); //56
	let upw17timer = new Shopitem("blaster",17,"timer",1); //57 
	let upw18timer = new Shopitem("blaster",18,"timer",1); //58
	let upw19timer = new Shopitem("blaster",19,"timer",1); //59
	//No boom upgrade for w0, w4, w6,w7 (probe, railgun, beam, double rainbow)
	let upw1boom = new Shopitem("blaster",1,"boom",1);//60 boom upgrades increase blast radius
	let upw2boom = new Shopitem("blaster",2,"boom",1);//61
	let upw3boom = new Shopitem("blaster",3,"boom",1);//62
	let upw5boom = new Shopitem("blaster",5,"boom",1);//63
	let upw8boom = new Shopitem("blaster",8,"boom",1);//64
	let upw9boom = new Shopitem("blaster",9,"boom",1);//65
	let upw11boom = new Shopitem("blaster",11,"boom",1);//66 boom upgrades increase blast radius
	let upw12boom = new Shopitem("blaster",12,"boom",1);//67
	let upw13boom = new Shopitem("blaster",13,"boom",1);//68
	let upw15boom = new Shopitem("blaster",15,"boom",1);//69
	let upw17boom = new Shopitem("blaster",15,"boom",1);//70
	let upw18boom = new Shopitem("blaster",18,"boom",1);//71
	let upw19boom = new Shopitem("blaster",19,"boom",1);//72
	//Only a few blasters get n upgrades (more projectiles). 
	let upw3n = new Shopitem("blaster",3,"n",1);//73
	let upw5n = new Shopitem("blaster",5,"n",1);//74
	let upw9n = new Shopitem("blaster",9,"n",1);//75
	let upw11n = new Shopitem("blaster",11,"n",1);//76
	let upw12n = new Shopitem("blaster",12,"n",1);//77
	let upw13n = new Shopitem("blaster",13,"n",1);//78
	//let upw15n = new Shopitem("blaster",15,"n",1);
	let upw17n = new Shopitem("blaster",17,"n",1);//79

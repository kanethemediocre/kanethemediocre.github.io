		...
		"You can cycle navigation modes between targeting planets, targeting stations, and off with the N key.  < and > will cycle through available nav targets.  The bottom right compass will point towards your nav target, and indicates name and distance.  The chart to the left gives more information if you're interested.  Try selecting planet Merz.",
			...
			"See how slowly it was launched?  Be careful not to fly into it!  The mine doesn't really get launched so much as dropped off with a gentle push.  It's up to to pilot to fly his ship to whatever momentum the mine needs, release and fly away.  The upshot is that the mine is both powerful and long-lasting.",
			...
			"Not every upgrade will be equally beneficial to every weapon, and sometimes it might pay to wait until you encounter a station with the upgrade(s) that you REALLY want before you spend your money and drive up the costs.",
			...
			"Great, both crates are delivered.   I'll need some time to sort through all this, so I'd suggest you spend some of those credits on your ship and maybe do some work from the mission board in the meantime.",
			"filler.",
			"filler.",
			"filler.",
			"filler.",

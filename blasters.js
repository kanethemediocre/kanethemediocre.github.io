...
//constructor(name,description,price,type,basedamage,updamage,maxdamage,basespeed,upspeed,maxspeed,baseboom,upboom,maxboom,basen,upn,maxn,basetimer,uptimer,maxtimer,nrg,ID)
	 ...
	 let weapon1 = new Blaster("Banger","Simple, but energy efficient blaster",300,"plain",                              12,6,10,12,2,10,0.8,0.2,10,1,0,0,40,8,10,12,"red","ID not implemented");
	 weapon1.phas = true; //this is the starter blaster
	 let weapon2 = new Blaster("Mine","Powerful but very slow moving bomb",500,"plain",                                  40,10,10,1,0,0,2,0.2,10,1,0,0,1800,300,10,40,"purple","ID not implemented");
	 let weapon3 = new Blaster("Flakker","Quickly detonating, short-range weapon with a wide area of effect",600,"plain",8,4,10,12,2,10,1.4,0.2,10,1,0,0,16,8,10,25,"green","ID not implemented");
	 let weapon4 = new Blaster("Railgun","Powerful, fast moving projectile with minimal blast radius",1000,"plain",      40,10,10,20,2,10,0.2,0,0,1,0,0,80,8,10,80,"blue","ID not implemented");

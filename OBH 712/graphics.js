...
function drawframe(x,y,xs,ys){
		context.beginPath(); //Border of map rectangle
		context.rect(x,y,xs,ys); //2*this.s wide
		context.lineWidth = 2; 
		context.strokeStyle = "blue";
		context.stroke();	
		context.beginPath(); //Border of map rectangle
		context.rect(x-2,y-2,xs+4,ys+4); //2*this.s wide
		context.lineWidth = 2; 
		context.strokeStyle = "purple";
		context.stroke();	
		context.beginPath(); //Border of map rectangle
		context.rect(x-4,y-4,xs+8,ys+8); //2*this.s wide
		context.strokeStyle = "red";
		context.stroke();	
		context.beginPath(); //Border of map rectangle
		context.rect(x-6,y-6,xs+12,ys+12); //2*this.s wide
		context.strokeStyle = "purple";
		context.stroke();
		context.beginPath(); //Border of map rectangle
		context.rect(x-8,y-8,xs+16,ys+16); //2*this.s wide
		context.strokeStyle = "blue";
		context.stroke();
	}
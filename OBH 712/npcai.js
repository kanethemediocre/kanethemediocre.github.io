class NPCAI{
	...
	turretlock(thesystem,target,distance,angle){
		var me = thesystem.npcs[this.id];
		//var distance = target.s+me.ship.s+8;
		me.ship.match(target);
		me.ship.x = target.x+Math.cos(angle)*distance;
		me.ship.y = target.x+Math.sin(angle)*distance;
		}

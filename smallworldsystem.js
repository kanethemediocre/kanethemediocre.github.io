function loadsmallworldsystem(){
	...
	sun.name = "Sool";
	let murc = new Umo(0,6000,150,"brown");//1//initial position irrelevant
	murc.name = "Murc";
	murc.setorbit(sun, 6000, 0, 1);
	murc.parentid = 0;
	murc.c2 = "darkred";
	let vnus = new Umo(0,10000,280,"yellow");//2
	vnus.name = "Vnus";
	vnus.setorbit(sun, 10000, 0, 1);
	vnus.parentid = 0;
	vnus.c2 = "tan";	
	let earf = new Umo(0, 14000, 320, "blue"); //3
	earf.setorbit(sun, 14000, 0, 1);
	earf.name = "Earf";
	earf.parentid = 0;
	earf.c2 = "green";
	let moon = new Umo(1000, 14000, 100, "white"); //4
	moon.name = "Moon";
	moon.setorbit(earf, 1000, 0, 1);
	moon.parentid = 3;
	moon.c2 = "grey";
	let merz = new Umo(0, 20000, 220, "brown");//5
	merz.name = "Merz";						
	merz.setorbit(sun, 20000, 0, 1);
	merz.parentid = 0;
	merz.c2 = "red";
	let fobz = new Umo(600,20000,32, "grey");//6
	fobz.name = "Fobz";
	fobz.setorbit(merz, 600, 0, 1);
	fobz.parentid = 5;
	fobz.c2 = "darkgrey";
	let deem = new Umo(-800,20000,32, "white");//7
	deem.name = "Deem";

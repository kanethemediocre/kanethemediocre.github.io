...
let merzianshopitems = [repairshopitem,blasterbuyitems[1],blasterbuyitems[2],blasterbuyitems[3],blasterupgradeitems[5],booster1,];
let merrymerz = new Shop("The Merry Merzian", 1, "I have these fine tapestries....", merzianshopitems);
let billshopitems = [repairshopitem,blasterbuyitems[1],blasterbuyitems[2],blasterupgradeitems[6],blasterupgradeitems[7],upgradeshopitems[1]];
let billbits = new Shop("Bills Billion Bits", 0, "Welcome to Earf", billshopitems);
let jojoshopitems = [repairshopitem,blasterbuyitems[4],blasterbuyitems[5],blasterbuyitems[8],blasterupgradeitems[6],upgradeshopitems[1],upgradeshopitems[2],upgradeshopitems[5]];
let jojocheese = new Shop("JoJo's House of Cheese", 2, "Jupe Fantastico", jojoshopitems);
let dangshopitems = [repairshopitem,blasterbuyitems[3],blasterbuyitems[6],blasterbuyitems[7],blasterupgradeitems[1],blasterupgradeitems[60],blasterupgradeitems[11],upgradeshopitems[4]];
let dangustown = new Shop("Dangustown", 3, "It's YOUR Anus!", dangshopitems);
let sharonshopitems = [repairshopitem,blasterbuyitems[1],blasterbuyitems[0],blasterupgradeitems[9],blasterupgradeitems[47],upgradeshopitems[74]];
...
let dadashopitems = [upgradeshopitems[0],blasterbuyitems[1],blasterbuyitems[2],blasterbuyitems[3],blasterupgradeitems[6],blasterupgradeitems[73],upgradeshopitems[1]];
let dadashop = new Shop("Ye Olde Space Shoppe",0,"The Gentleman's Outfitter",dadashopitems);

let hijoshopitems = [upgradeshopitems[0],blasterbuyitems[4],blasterbuyitems[10],blasterbuyitems[7],blasterupgradeitems[74],blasterupgradeitems[7],blasterupgradeitems[15]];
let hijoshop = new Shop("Not Your Dada's Spaceport",1,"Welcome to our new location",hijoshopitems);

let fantshopitems = [upgradeshopitems[0],blasterbuyitems[10],blasterbuyitems[14],blasterbuyitems[0],blasterupgradeitems[11],blasterupgradeitems[17],blasterupgradeitems[18]];
let fantshop = new Shop("Want-Fant",2,"You want it, Fant has it.",fantshopitems);

let stanshopitems = [upgradeshopitems[0],blasterbuyitems[13],blasterbuyitems[7],blasterbuyitems[8],blasterupgradeitems[13],blasterupgradeitems[9]];
...
let arisshopitems = [upgradeshopitems[0],blasterbuyitems[3],blasterbuyitems[5],blasterbuyitems[6],blasterupgradeitems[21],blasterupgradeitems[22],blasterupgradeitems[23],blasterupgradeitems[24]];
let arisshop = new Shop("The Foob",0,"yaaaaa",arisshopitems);
let luxeshopitems = [upgradeshopitems[0],blasterbuyitems[1],blasterbuyitems[4],blasterbuyitems[7],blasterupgradeitems[13],blasterupgradeitems[46],blasterupgradeitems[69]];

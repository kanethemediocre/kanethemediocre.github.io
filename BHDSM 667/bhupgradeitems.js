function bhupgradeitems(){
	...
	//Removed cargo, sensor, and solar upgrades for Deep Space Mine
	return [uprepairitem,uparmoritem,upshielditem,upshieldregenitem,upradaritem,upthrustitem,upimpactitem,randomchassisitem];
	}

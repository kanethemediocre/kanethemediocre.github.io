		...
		while  (i<this.players.length){
			...
			if ((xdif < xtol)&&(xdif > -1*xtol)){
				...
				if ((ydif < ytol)&&(ydif>-1*ytol)){
					...
					this.players[i].updatesparks();
					this.players[i].drawsparks(viewx,viewy);	
					}		
				}		
...
//////////////////turret bombs hitting ships and players///////////////////////////////////////////////
	...
	playermice(){
		...
		while (qq<this.players.length){
			...
			//aplayer.mousestate = 0;//Need to handle this server-side in actual multiplayer so w6 can work.	ork.
			qq++;
			}
		}
	playerkeys(){
	...
	randomoutposts(num){//num is number of outposts
		...
		while (i<num){//
			...
			this.shops.push(new Shop(this.outposts[lastindex].name,lastindex, "no description", randshopitems3)); //should fix this to reflect outpost name/description
			var k = 0;
	...
	randomoutpostat(opx,opy){//Only used in bubble universe currently.
		this.outposts.push( new Umo(0,0,128, randcolor()));
		var lastindex = this.outposts.length-1;
		this.outposts[lastindex].c2 = randcolor();
		this.outposts[lastindex].parentid = 0;
		...
		//	j=j+1;
		//	}
		this.shops.push(new Shop(this.outposts[lastindex].name,lastindex, "whaaaaaaaaaaaaaat", randshopitems3)); //should fix this to reflect outpost name/description
		var k = 0;
		while (k<4){ //This adds 4 cargo missions to the shop.  

...
class NPC{
	...
	drawdebug(viewx, viewy){ //Draws npc money
	...
	drawlevel(viewx, viewy){ //Draws ship level, red for enemy, blue for friendly
		var x = this.ship.x - viewx + canvas.width/2; //normally camera center being the player ship.
		var y = this.ship.y - viewy + canvas.height/2;
		//var level = ""+this.ship.level;
		context.fillStyle = "blue";
		context.font='24px Arial';
		if (this.ai.playerhostile){
			context.fillStyle = "red";
			}
		context.fillText(this.ship.level,x-4-Math.floor(this.ship.level/10)*8,y+this.ship.s+24);
		}
	addspark(){

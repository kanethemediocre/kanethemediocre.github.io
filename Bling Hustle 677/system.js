			...
			if (this.npcs[i].alive==true){
				...
				if ((xdif < xtol)&&(xdif > -1*xtol)){
					...
					if ((ydif < ytol)&&(ydif>-1*ytol)){
						...
						this.npcs[i].drawlevel(viewx, viewy); //drawlevel(viewx, viewy){ 
...
//////////////////turret bombs hitting ships and players///////////////////////////////////////////////
	...
	randomoutposts(num){//num is number of outposts
		...
		while (i<num){//
			...
			this.shops.push(new Shop(this.outposts[lastindex].name,i, "description goes here", randshopitems3)); //should fix this to reflect outpost name/description
			var k = 0;

...
///////////////Navigation hud///////////////////////////////////////////////////////////////////////////////////////////////////////////
	if (myplayer.navactive > 0){
		...
		drawframe(canvas.width-500,canvas.height-180,500,180);
		var thenavtarget=0;
...
///////////////Rest of HUD/////////////////////////////////////////////////////////////////////////////////////////////////	
	if (myplayer.transparentui == false){
		...
		context.fillStyle = "#080808";
		context.fillRect(0,0,160,250);
		}
	drawframe(0,0,160,250);//function drawframe(x,y,xs,ys){
	...
	context.fillStyle = "green"; 
	context.fillText("task: "+myplayer.task,8,276);//The task is a brief description of the last thing a player was asked to do.
	context.fillStyle = "yellow";
	context.fillText("job: "+myplayer.job,8,300);//Jobs are missions taken from station menus.  This indicates latest and how many jobs.

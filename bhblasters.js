//constructor(name,description,price,type,basedamage,updamage,maxdamage,basespeed,upspeed,maxspeed,baseboom,upboom,maxboom,basen,upn,maxn,basetimer,uptimer,maxtimer,nrg,bombcolor,ID){
 function bhblasters(){
	 ...
	 40,10,10,0.5,0,0,2,0.2,10,1,0,0,1800,300,10,40,"purple","ID not implemented");
	 ...
	 10,4,10,12,4,10,1,0.2,10,1,0,0,32,16,10,11,"white","ID not implemented");
	 ...
	 let weapon19 = new Blaster("Denier","Great walls of fire, come from the denier.  ",42069,"rapidmultiplex",                            

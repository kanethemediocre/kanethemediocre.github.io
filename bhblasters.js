//constructor(name,description,price,type,basedamage,updamage,maxdamage,basespeed,upspeed,maxspeed,baseboom,upboom,maxboom,basen,upn,maxn,basetimer,uptimer,maxtimer,nrg,bombcolor,ID){
 function bhblasters(){
	 ...
	 let weapon11 = new Blaster("Multibanger","Parallel projectiles",300,"multiplex",                            
	 12,6,10,12,2,10,0.8,0.2,10,2,0,0,40,8,10,12,"pink","ID not implemented");
	 ...
	 12,6,10,12,2,10,0.8,0.2,10,16,8,10,40,8,10,48,"tan","ID not implemented");
	 weapon13.special1 = 4*Math.PI/2;
	 weapon13.special2 = 8*Math.PI/4;
	 let weapon14 = new Blaster("Fast Railgun","Fires a pair of powerful, fast bombs.",300,"semirapid",                            
	 24,8,10,20,4,4,0.3,0,0,6,0,0,64,16,10,25,"grey","ID not implemented");
	 let weapon15 = new Blaster("Gemini Cutter","Rapidly fires 2 projectiles at a time.  ",300,"rapidmultiplex",                            
	 ...
	 let weapon18 = new Blaster("wangus","Medium range, rapid-firing blaster with good damage output.  Hold the left mouse button down instead of tapping it.",300,"rapid",                            
	 12,6,10,12,2,10,0.8,0.2,10,24,0,0,64,8,10,15,"olive","ID not implemented");
	 let weapon19 = new Blaster("Denier","Great walls of fire, come from the denier.  ",300,"rapidmultiplex",                            
	 6,3,10,4,2,10,0.8,0.2,10,84,12,10,160,8,10,10,"skyblue","ID not implemented");
